...
public class ConnectAndJoinRandomLb : MonoBehaviour, IConnectionCallbacks, IMatchmakingCallbacks, ILobbyCallbacks
{
    ...
    private const string MAP_PROD_KEY = "C0";
    private const string GOLD_PROD_KEY = "C1";
    ...
    public void OnConnectedToMaster()
    {
        ...
        var roomOptions = new RoomOptions
        {
            MaxPlayers = 10,
            PublishUserId = true,
            CustomRoomPropertiesForLobby = new[] { MAP_PROD_KEY, GOLD_PROD_KEY },
            CustomRoomProperties = new ExitGames.Client.Photon.Hashtable { { GOLD_PROD_KEY , 300}, { MAP_PROD_KEY, "Map3" } }
        };
        var enterRoomParams = new EnterRoomParams
        {
            RoomName = "NewRoom",
            RoomOptions = roomOptions,
            ExpectedUsers = new[] { "65432135456" }, //указываем айдишники игроков
            Lobby = _sqlLobby
        };
    ...
    {
        var sqlLobbyFilter = $"{MAP_PROD_KEY} = Map3 AND {GOLD_PROD_KEY} BETWEEN 200 AND 400";
